...
import badgeAppStore from '@/assets/badge-appstore-soon.jpg';
    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        <span className="flex-shrink-0 opacity-70 cursor-not-allowed">
          <img src={badgeAppStore} alt="Coming soon to App Store" className={BADGE_CLASS} />
        </span>

        {/* Play Store — Coming Soon */}
        <span className="flex-shrink-0 opacity-70 cursor-not-allowed">
          <img src={badgePlayStore} alt="Coming soon to Google Play" className={BADGE_CLASS} />
        </span>
      </div>
